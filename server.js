...
function foodMatchesOrder(
    ...
    /*
       Old saved orders may contain only
       requestedFoodName.
    */
            ...
            try {
                ...
                if (
                    ...
                    if (
                        ...
                        sendJSON(
                            ...
                            400,
                            {
                                ...
                                message:
                                    "Select a valid NGO, food category and meal quantity."
                            }
                        );
                    ...
                    addNotification(
                        "NGO_REQUEST",
                        ngo.name,
                        `${ngo.name} requested ${requiredMeals} meals from ${requestedFoodCategory} category.`
                    );
                    ...
                    sendJSON(
                        ...
                        201,
                        {
                            ...
                            message:
                                `${order.allocatedMeals}/${requiredMeals} meals from ${requestedFoodCategory} category matched.`
                        }
                    );
...
server.on(
    ...
    (error) => {
        if (
            ...
            console.error(
                `Port ${PORT} is already in use. Stop the old server before starting a new one.`
            );
